    ...
    <table id="antrian" style="width:100%" class="table table-striped table-bordered">
        ...
        @foreach($data_antrian as $row)
            <tr>
                ...
                <td><a href="/isilab?id_registrasi={{$row->no_registrasi}}&id_laboratorium={{$row->id_laboratorium}}" class="btn btn-warning text-white font-weight-bold" style="border-radius: 25px;">Proses Laboratorium ></a> </td>
                <td>
